...
def masume():
    ...
    if shirushi == 0:
        cvs.create_text(300,300,text="スタート",fil="navy",font=FNT)
    cvs.update()
...
def syouhai():
    global shirushi
    if hanteiflg==1:
        cvs.create_text(300,300,text="あなたの勝ち！！",fil="cyan",font=FNT)
        shirushi=9
    if hanteiflg==2:
        cvs.create_text(300,300,text="CPUの勝ち！！",fil="gold",font=FNT)
        shirushi=9
    if hanteiflg==0 and hanteiflg==9:
        cvs.create_text(300,300,text="引き分け",fil="lime",font=FNT)
